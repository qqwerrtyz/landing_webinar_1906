...
export default function Home() {
  return (
    <main id="top">
      ...
      <section id="registration" className="registration section-pad">
  <div className="container registration__single">

    <div className="registration__content registration__content--center">
      ...
      <p style={{ textAlign: "center", maxWidth: "720px", margin: "0 auto" }}>
        Мы провели бесплатный вебинар для родителей.
        Сейчас регистрация закрыта, но вы можете продолжить обучение на нашей платформе с курсами и практическими материалами.
      </p>

      <div className="registration__highlight" style={{ textAlign: "center", margin: "24px auto" }}>
        <b>Следующий шаг обучения</b>
        <span>
          Перейдите к курсам и получите доступ к программам ABA-терапии, развитию речи и работе с поведением
        </span>
      </div>
      ...
      >
        <a className="btn btn--primary" href="https://novaya-planeta-academy.ru/premium_club_parents">
          Перейти к курсам
        </a>
