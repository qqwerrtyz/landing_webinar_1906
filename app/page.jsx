...
const bonuses = [
  ...
  "Секретный бонус только для участников прямого эфира",
];
        ...
        <div className="container hero__grid">
          <div className="hero__content">
            ...
            <p className="hero__lead">
              Практический эфир о том, как оценить специалиста, когда начинать занятия
      ...
      <section id="program" className="section-pad section-muted">
        <div className="container">
          <div className="section-heading">
            ...
            <p>
              Мы собрали эфир вокруг практических вопросов: как не ошибиться со специалистом,
        ...
        <div className="container funds__grid">
          <div className="funds__content">
            ...
            <p>
              ...
              На эфире покажем, как выбирать фонд, как писать обращение и какие документы обычно готовят заранее.
            </p>
